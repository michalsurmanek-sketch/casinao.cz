(function () {
  ...
  nav.className = 'mbottom-nav';
  nav.setAttribute('aria-label', 'Spodni mobilni navigace');

  nav.innerHTML = [
    '<div class="mbottom-nav__inner">',
    '  <a href="/index.html" class="mbottom-nav__item" data-mobile-shared-item="home">',
    '    <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 11.5 12 4l9 7.5"></path><path d="M6.5 10.8V20h11V10.8"></path></svg>',
    '    <span class="mbottom-nav__label">Domu</span>',
    '  </a>',
    '  <a href="/index.html#casina" class="mbottom-nav__item" data-mobile-shared-item="casina">',
    ...
    '  </a>',
    '  <a href="/bonusy.html" class="mbottom-nav__item" data-mobile-shared-item="bonusy">',
    ...
    '  </a>',
    '  <a href="/index.html#casina" class="mbottom-nav__item" data-mobile-shared-item="top">',
    ...
    '  </a>',
    '  <a href="/kontakt.html" class="mbottom-nav__item" data-mobile-shared-item="menu">',
